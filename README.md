...
To facilitate immediate testing and reproducibility of the basic model, the **PEMS08** dataset (and links to **PEMS04**) are provided in here, however should be put in the `datasets/PEMS08` directory. PEMS08 is included directly due to its manageable size, allowing reviewers and researchers to execute the `basic_spectrafed.py` script without extensive data downloading.

* **PEMS08**: Included in this repository (`PEMS08.zip`). Contains 170 sensors and 17,856 time steps.
